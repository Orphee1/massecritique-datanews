  ...
  return (
    <div className="">
      <div className="reactVis-flex1 remove414">
        ...
        <h5 style={{ color: option.syntax }}>Ensemble du territoire</h5>
        <LineSeriesNewCase
          data={dataToDisplay}
      ...
      >
        ...
        <div className="chart-age-container">
          <div className="chart-age-box">
            <COVIDAgeBar data={dataDCATodisplay} type="Décès" />
          </div>
          <div className="chart-age-box">
            <COVIDAgeBar data={dataHATodisplay} type="Patients hospitalisés" />
          </div>
          <div className="chart-age-box">
            <COVIDAgeBar
